...
class Booking(models.Model):
    ...
    accomondation = models.ForeignKey(
        Listing,
        on_delete=models.CASCADE,
...
class Payment(models.Model):
    ...
    payment_status = models.CharField(max_length=25, choices=STATUS_CHOICES)
